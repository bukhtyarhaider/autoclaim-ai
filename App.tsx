      ...
      if (isLoading) {
        return (
          <div className="flex flex-col items-center justify-center min-h-[60vh]">
            ...
            <p className="text-slate-500 mt-2 animate-pulse">Detecting damages, calculating costs...</p>
          </div>
        );
      }
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 animate-in fade-in duration-500">
        <div className="text-center mb-12">
          {!user && (
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 text-blue-700 text-sm font-medium mb-6 animate-bounce">
